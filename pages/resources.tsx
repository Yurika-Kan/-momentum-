...
export default function Resources() {
  ...
  return (
    <>
      ...
      {/* Navigation Bar */}
      <nav className="bg-gradient-to-r from-blue-700 to-blue-800 p-6 h-20 fixed top-0 w-full z-40">
        ...
        <div className="relative w-full h-[300px] flex justify-center items-center">
          <div className="absolute flex justify-center items-center w-full h-full">
            {boxes.map((box, index) => (
              <div
                key={index}
                className={`absolute inset-x-0 mx-auto text-center p-4 bg-blue-600 text-white font-bold transition-opacity duration-500 w-full max-w-[33.33%] ${currentIndex === index ? "opacity-100" : "opacity-0"
                  }`}
